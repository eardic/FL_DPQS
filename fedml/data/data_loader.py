...
from .breakhis_v1.data_loader import load_partition_data_breakhisv1
from .chest_xray.data_loader import load_partition_data_chest_xray
from .chexpert import load_partition_data_chexpert
from .chexpert_pneumonia.data_loader import load_partition_data_pneumonia
from .isic2019.data_loader import load_partition_data_isic2019
from .oct_retina.data_loader import load_partition_data_oct_retina
from .pansmear.data_loader import load_partition_data_pansmear
...
def load_synthetic_data(args):
    if args.training_type == "cross_silo" and hasattr(args, 'synthetic_data_url') and args.synthetic_data_url.find(
            "https") != -1:
    ...
    if dataset_name == "mnist":
        ...
        (
            ...
            test_data_local_dict,
            class_num,
        ) = load_partition_data_breakhisv1(
            args.dataset,
            args.data_cache_dir,
            args.partition_method,
            args.partition_alpha,
    ...
    elif dataset_name == "chexpert_pneumonia":
        (
            train_data_num,
            test_data_num,
            train_data_global,
        ...
        (
            ...
            test_data_local_dict,
            class_num,
        ) = load_partition_data_chest_xray(
            args.dataset,
            args.data_cache_dir,
            args.partition_method,
            args.partition_alpha,
        ...
        (
            ...
            test_data_local_dict,
            class_num,
        ) = load_partition_data_oct_retina(
            args.dataset,
            args.data_cache_dir,
            args.partition_method,
            args.partition_alpha,
        ...
        if dataset_name == "cifar10":
            ...
            print("Warning: Using cifar10 dataset !")
            data_loader = load_partition_data_cifar10
        (
            train_data_num,
            test_data_num,
